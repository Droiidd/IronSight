          ...
          case "kit":
            switch (strings[1].toLowerCase()) {
              case "bandit" -> {
                ...
                p.getInventory()
                    .setBoots(CustomItem.getCustomItem("Journeymen Boots").getItemStack());
                p.getInventory()
                    .setLeggings(CustomItem.getCustomItem("Journeymen Pants").getItemStack());
                p.getInventory()
                    .setChestplate(CustomItem.getCustomItem("Journeymen Duster").getItemStack());
                p.getInventory()
                    .setHelmet(CustomItem.getCustomItem("Journeymen Hat").getItemStack());
              ...
              case "marshall" -> {
                ...
                p.getInventory().addItem(rifle);
                p.getInventory()
                    .setBoots(CustomItem.getCustomItem("Marshall Boots").getItemStack());
                p.getInventory()
                    .setLeggings(CustomItem.getCustomItem("Marshall Pants").getItemStack());
                p.getInventory()
                    .setChestplate(CustomItem.getCustomItem("Marshall Jacket").getItemStack());
              ...
              default -> {
                p.sendMessage(
                    ChatColor.RED + "Incorrect usage. " + ChatColor.GRAY + "Try /is kit *kitName*");
              }
            }
        }
      }
