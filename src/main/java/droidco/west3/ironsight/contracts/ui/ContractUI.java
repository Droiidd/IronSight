...
public class ContractUI {
  ...
  public static Inventory openContractorTitleSelectUi(Player p) {
    Inventory contractUi =
        Bukkit.createInventory(p, 27, ChatColor.DARK_GRAY + "Contractor Title Select:");
  ...
  public static Inventory openContractOptionsUi(Player p) {
    Inventory contractUi =
        Bukkit.createInventory(p, 27, ChatColor.DARK_GRAY + "Select a Contract: (Click to start!)");
    Bandit b = Bandit.getPlayer(p);

    contractUi.setItem(11, GlobalUtils.getContractSlot(b.getRookieContract(), Difficulty.ROOKIE));
    contractUi.setItem(
        13, GlobalUtils.getContractSlot(b.getApprenticeContract(), Difficulty.APPRENTICE));
    contractUi.setItem(
        15, GlobalUtils.getContractSlot(b.getExperiencedContract(), Difficulty.EXPERIENCED));
  ...
  public static ItemStack getContractorIcon(Player p) {
    ...
    skullLore.add(
        ChatColor.GREEN
            ...
            + ChatColor.GRAY
            + "["
            + BanditUtils.getContractorLvlColor(nextLvl)
            + ChatColor.GRAY
            + "] "
            + b.getContractorXp()
            + " / "
            + BanditUtils.getXpRequiredForLevel(b)
            + " XP");
  ...
  public static ItemStack getActiveContractIcon(Player p, Bandit b) {
    ...
    if (b.getActiveContract() != null) {
      ...
      double percentage =
          ((double) totalAmountReqItems / (double) b.getActiveContract().getRequestedAmount())
              * 100;
      ...
      lore.add(
          ChatColor.GRAY
              ...
              + totalAmountReqItems
              + " / "
              + b.getActiveContract().getRequestedAmount()
              + " "
              + b.getActiveContract().getRequestedItem().getItemMeta().getDisplayName());
      iMeta.setLore(lore);
    }
  ...
  public static Inventory openLvlRewardMenu(Player p) {
    ...
    menu.setItem(
        11, rewardIcon(Material.YELLOW_WOOL, 2, "5% bonus to all contracts", null, null, null));
    ...
    menu.setItem(
        ...
        rewardIcon(
            ...
            4,
            "Unlock Cowboy Prefix",
            "Animal hide sells for 10% more gold",
            null,
            null));
    menu.setItem(
        14,
        rewardIcon(
            Material.LIME_WOOL,
            5,
            "Unlock Tracker Prefix",
            "10% bonus to all contracts (stacked)",
            null,
            null));
    menu.setItem(
        15,
        rewardIcon(
            Material.LIME_WOOL,
            6,
            "Morphine potion is now craftable",
            "Thoroughbred horse available for purchase",
            null,
            null));
    menu.setItem(
        16,
        rewardIcon(
            Material.LIME_WOOL,
            7,
            "Unlock Second Contract Slot",
            "Miner's Frenzy Brew is now craftable",
            null,
            null));
    menu.setItem(
        17,
        rewardIcon(
            ...
            8,
            "Donkey available for purchase",
            "Whiskey potion is now craftable",
            null,
            null));
    menu.setItem(
        18,
        rewardIcon(
            Material.LIGHT_BLUE_WOOL,
            9,
            "Unlock Raider Prefix",
            "Double spade brew is now craftable",
            "10% bonus to all contracts (stacked)",
            null));
    menu.setItem(
        19,
        rewardIcon(
            ...
            10,
            "Unlock Explorer Prefix",
            "3% chance to mine double the ore",
            "Camel available for purchase",
            null));
    menu.setItem(
        20,
        rewardIcon(
            Material.MAGENTA_WOOL,
            11,
            "Unlock Farmer Prefix",
            "Green thumb brew is now craftable",
            "3% chance to harvest double the crops",
            null));
    menu.setItem(
        21,
        rewardIcon(
            ...
            12,
            "Unlock Medic Prefix",
            "Medicine potion is now craftable",
            "1% chance not to consume potions",
            "5% bonus to all contracts (stacked)"));
    menu.setItem(
        22,
        rewardIcon(
            Material.RED_GLAZED_TERRACOTTA,
            13,
            "Unlock third contract slot",
            "4% chance not to consume pots",
  ...
  public static ItemStack rewardIcon(
      Material mat, int level, String reward1, String reward2, String reward3, String reward4) {
    ...
    iMeta.setDisplayName(
        ChatColor.AQUA
            ...
            + ChatColor.GRAY
            + "["
            + BanditUtils.getContractorLvlColor(level)
            + ChatColor.GRAY
            + "] : "
            + xpForLvl
            + " XP");
