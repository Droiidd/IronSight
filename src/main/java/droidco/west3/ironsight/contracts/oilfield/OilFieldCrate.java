...
public class OilFieldCrate {
  private static final HashMap<String, OilFieldCrate> crates = new HashMap<>();
  ...
  public OilFieldCrate(
      int crateNumber, FrontierLocation frontierLocation, int crateX, int crateY, int crateZ) {
