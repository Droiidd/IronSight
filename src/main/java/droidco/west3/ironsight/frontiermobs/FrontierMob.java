...
public class FrontierMob {
  @Getter private static HashMap<UUID, FrontierMob> mobs = new HashMap<>();
  @Getter private static HashMap<UUID, LivingEntity> entities = new HashMap<>();
  ...
  public void spawnMob(Player p) {
    ...
    p.sendMessage(
        "X: " + spawnBlock.getX() + " Y: " + spawnBlock.getY() + " Z: " + spawnBlock.getZ());

    Location spawnLoc =
        new Location(p.getWorld(), spawnBlock.getX(), spawnBlock.getY(), spawnBlock.getZ());

    switch (type) {
      case UNDEAD_MINER -> {
        Skeleton miner = p.getWorld().spawn(spawnLoc, Skeleton.class);
        miner.addPotionEffect(
            new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 10000000, 1, false, false));
        miner.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 10000000, 1, false, false));
        miner.addPotionEffect(
            new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 10000000, 2, false, false));
        ...
        miner
            .getEquipment()
            .setChestplate(CustomItem.getCustomItem("Huntsmen Jacket").getItemStack());
        miner
            .getEquipment()
            .setLeggings(CustomItem.getCustomItem("Huntsmen Trousers").getItemStack());
      ...
      case CORRODED_MINER -> {
        ...
        if (chance % 7 == 0) {
          miner
              .getEquipment()
              .setItemInMainHand(CustomItem.getCustomItem("Flame Bow").getItemStack());
        } else {
          miner
              .getEquipment()
              .setItemInMainHand(CustomItem.getCustomItem("Hard Bow").getItemStack());
        }
        this.mobId = miner.getUniqueId();
        mobs.put(mobId, this);
        entities.put(mobId, miner);
      ...
      case WILD_DOG -> {
        ...
        wolf.addPotionEffect(
            new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 1000000, 3, false, false));
        wolf.addPotionEffect(
            new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 1000000, 2, false, false));
      ...
      case RANGER -> {
        ...
        raider.addPotionEffect(
            new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 1000000, 1, false, false));
      ...
      case RAIDER_BRUTE -> {
        ...
        raider.addPotionEffect(
            new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 1000000, 1, false, false));
        raider.addPotionEffect(
            new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 1000000, 1, false, false));
        mobs.put(mobId, this);
        entities.put(mobId, raider);
      }
      case BOAR -> {
        ...
        // animal.addPotionEffect(new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 1000000, 2,
        // false, false));
      ...
      case RABBIT -> {
        ...
        animal.addPotionEffect(
            new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 1000000, 2, false, false));
        animal.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 1000000, 1, false, false));
        mobs.put(mobId, this);
        entities.put(mobId, animal);
      }
