...
public class Processor {
  ...
  private static final HashMap<String, Processor> processorsById = new HashMap<>();
  ...
  public Processor(
    ...
    this.displayName = ChatColor.RED + processorCode;
  ...
  public void randomizeProcLocation(Player p) {
    ...
    if (this.defaultPosition == null) {
      ...
      createVillager(ChatColor.RED + this.processorCode, this.defaultLocation);
      // removing from pool
