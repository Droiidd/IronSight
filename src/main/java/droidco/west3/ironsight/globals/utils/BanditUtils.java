  ...
  public static String getRandomTip() {
    ...
    tips.add(
        ChatColor.AQUA
            + "[Tip] "
            + ChatColor.WHITE
            + "Contracts are the quickest way to earn money");
    ...
    tips.add(
        ChatColor.AQUA
            + "[Tip] "
            + ChatColor.WHITE
            + "Locate a contractor NPC to start a contract");
    tips.add(
        ChatColor.AQUA
            + "[Tip] "
            + ChatColor.WHITE
    ...
    tips.add(
        ChatColor.AQUA + "[Tip] " + ChatColor.WHITE + "Do /call or /horse to summon your steed");
    tips.add(
        ChatColor.AQUA
            + "[Tip] "
            + ChatColor.WHITE
