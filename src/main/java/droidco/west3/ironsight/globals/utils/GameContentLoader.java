...
public class GameContentLoader {
  public static void loadCustomItems() {
    ...
    new CustomItem(
        ...
        0.0);
    new CustomItem(
        "Iron Ore", 2, true, false, "Can be refined or sold", Material.RAW_IRON, 30.0, 0.0);
    new CustomItem(
        "Copper Ore", 1, true, false, "Can be refined or sold", Material.RAW_COPPER, 44.0, 0.0);
    ...
    new CustomItem(
        ...
        0.0);
    new CustomItem(
        "Boar Carcass", 3, true, false, "Right click to skin", Material.MUSIC_DISC_MALL, 55.0, 0.0);
    new CustomItem(
        "Cow Carcass", 3, true, false, "Right click to skin", Material.MUSIC_DISC_STRAD, 40.0, 0.0);
    new CustomItem(
        "Gold Ore", 3, true, false, "Can be refined or sold", Material.RAW_GOLD, 69.0, 0.0);
    new CustomItem(
        "Geode", 4, true, false, "Bring to geologist to open", Material.FIREWORK_STAR, 0.0, 0.0);
    new CustomItem(
    ...
    new CustomItem(
        ...
        0.0);
    new CustomItem(
        "Spice", 4, false, false, "Smell's like the future", Material.HONEY_BOTTLE, 65, 0.0);
    new CustomItem(
        "Unrefined Oil",
        4,
        false,
    ...
    new CustomItem(
        "Refined Oil", 6, false, false, "Highly sought after", Material.LAVA_BUCKET, 90.0, 0.0, 1);
    new CustomItem(
        "Southern Salmon",
        6,
        true,
    ...
    // LEGENDARY
    new CustomItem(
        "Alligator", 8, true, false, "Crikey!", Material.MUSIC_DISC_CHIRP, 825.0, 0.0, 1);
    new CustomItem(
        "Sunken Catfish",
        8,
        true,
    ...
    new CustomItem(
        ...
        1);
    new CustomItem(
        "River Diamond", 7, true, false, "The root of many wars", Material.DIAMOND, 1355.0, 0.0, 1);
    new CustomItem(
        "Baron's Emerald",
        7,
        true,
  ...
  public static void loadLocations(IronSight plugin) {
    ...
    new FrontierLocation(
        ...
        2520.0);
    new FrontierLocation(
        "Red Gail Canyon Lobby", "PvP Disabled!", LocationType.TOWN, 10058, 9943, 9919, 10075);
    // MISC
  ...
  public static void loadIcons() {
    ...
    //      ===--- CONTRACT UI ICONS ---===
    new ItemIcon(
        String.valueOf(ChatColor.BOLD) + "Locations:",
        "contract_location",
        "Go here to complete.",
        Material.COMPASS);
    new ItemIcon(
        String.valueOf(ChatColor.BOLD) + "Request:",
        "contract_req",
        "Requested items:",
        Material.DIAMOND);
    new ItemIcon(
        String.valueOf(ChatColor.BOLD) + "Description",
        "contract_desc",
        "What to do:",
        Material.MOJANG_BANNER_PATTERN);

    new ItemIcon(
        "Next Page", "next_page", "Click to go to next page", Material.MAGENTA_GLAZED_TERRACOTTA);
    new ItemIcon(
        "Previous Page",
        "previous_page",
    ...
    new ItemIcon(
        "Open Geode", "open_geode", "Click to crack any geode open!", Material.MUSIC_DISC_11);
    ...
    new ItemIcon(
        "Contractor Title", "contractor_title", "Select your prefix", Material.SPRUCE_HANGING_SIGN);
    new ItemIcon("Remove Title", "remove_title", "Click to reset prefix", Material.PLAYER_HEAD);
    new ItemIcon(
        String.valueOf(ChatColor.BOLD) + "Back",
        "back_button",
        "return to previous page",
        Material.BARRIER);

    new ItemIcon(
        String.valueOf(ChatColor.GREEN) + "ROOKIE Difficulty",
        "rookie_slot",
        "",
        Material.PLAYER_HEAD);
    new ItemIcon(
        String.valueOf(ChatColor.YELLOW) + "APPRENTICE Difficulty",
        "apprentice_slot",
        "",
        Material.SKELETON_SKULL);
    new ItemIcon(
        String.valueOf(ChatColor.RED) + "EXPERIENCED Difficulty",
        "experienced_slot",
        "",
    ...
    // new ItemIcon("Open Geode", "open_geode", "Click to crack open a geode",
    // Material.IRON_PICKAXE);
    //      ===--- VAULTKEEPER ITEMS ---===
    ...
    new ItemIcon(
        "Process Smokeleaf", "process_smokeleaf", "Input: 12, Output: 3", Material.GREEN_DYE);
