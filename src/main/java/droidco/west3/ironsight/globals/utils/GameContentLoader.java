...
public class GameContentLoader {
  public static void loadCustomItems() {
    ...
    // COMMONS
    new CustomItem(
        "Brown Stew", 1, true, false, "What's in this..?", Material.MUSHROOM_STEW, 0.0, 2.0, 1);
    new CustomItem(
        "Charred Potato",
        1,
        true,
    ...
    new CustomItem(
        ...
        true,
        false,
        "Bigger drumstick than chicken!",
        Material.COOKED_CHICKEN,
        0.0,
        5.0,
        4);
    new CustomItem(
        "Rabbit Stew", 2, true, false, "Delicious with bread", Material.RABBIT_STEW, 0.0, 3.0, 1);
    new CustomItem(
        "Cooked Rabbit",
        2,
        true,
        false,
        "Get's you through winter",
    ...
    CustomItem shotAmmo =
        new CustomItem(
            "Shotgun Ammo", 2, true, false, "Buckshot only.", Material.WHEAT_SEEDS, 0.0, 20.0, 6);
    CustomItem pistolAmmo =
        new CustomItem(
            "Pistol Ammo",
            1,
            true,
            false,
            "Load your favorite .22",
            Material.NETHER_WART,
            0.0,
            17.0,
            8);
    CustomItem rifleAmmo =
        new CustomItem(
            "Rifle Ammo", 2, true, false, "Imported from China", Material.CLAY_BALL, 0.0, 24.0, 8);
    CustomItem bandage =
        new CustomItem(
            "Bandage", 2, true, false, "Used to heal bloody wounds", Material.PAPER, 0.0, 9.0, 6);
    CustomItem splint =
        new CustomItem(
            "Splint", 2, true, false, "Used to heal broken bones", Material.STICK, 0.0, 8.0, 4);
    CustomItem tracker =
        new CustomItem(
            "Tracker", 1, true, false, "Track different locations", Material.COMPASS, 0.0, 10.0, 1);
    CustomItem glassBottle =
        new CustomItem(
            "Glass Bottle",
            2,
            true,
            ...
            15.0,
            3);
    CustomItem fishingRod =
        new CustomItem(
            "Wooden Fishing Rod",
            2,
            true,
            false,
            "Basic stick and line",
            Material.FISHING_ROD,
            0.0,
            200.0,
            1);
    CustomItem unSmokeLeaf =
        new CustomItem(
            "Unprocessed Smokeleaf",
            2,
            false,
            false,
            "Process to consume",
    ...
    CustomItem iron =
        new CustomItem(
            "Iron Ore", 2, true, false, "Can be refined or sold", Material.RAW_IRON, 10.0, 0.0);
    CustomItem copper =
        new CustomItem(
            "Copper Ore", 1, true, false, "Can be refined or sold", Material.RAW_COPPER, 14.0, 0.0);

    // UNCOMMON
    CustomItem smokedSalmon =
        new CustomItem(
            "Smoked Salmon",
            3,
            true,
            false,
            "Fresh caught, fresh smoked",
            Material.COOKED_SALMON,
            0.0,
            10.0,
            3);
    CustomItem fermentedLiquor =
        new CustomItem(
            "Fermented Liquor",
            4,
            true,
            false,
            "Extra kick to any home brew",
    ...
    CustomItem crappie =
        new CustomItem(
            "Poor Mans Crappie", 3, true, false, "Skinniest fish", Material.COD, 10.0, 0.0);
    CustomItem grayHerring =
        new CustomItem(
            "Gray Stoned Herring",
            3,
            true,
            false,
            "The cheapest of Herring",
            Material.SALMON,
            13.0,
            0.0);
    CustomItem chub =
    ...
    CustomItem gold =
        new CustomItem(
            "Gold Ore", 3, true, false, "Can be refined or sold", Material.RAW_GOLD, 19.0, 0.0);
    CustomItem slug =
        new CustomItem(
            "Sea Slug", 3, true, false, "Reaks of the sea", Material.SPIDER_EYE, 4.0, 8.0, 4);
    CustomItem boarmeat =
        new CustomItem(
            "Boar Meat", 3, true, false, "Closest thing to bacon", Material.PORKCHOP, 7.0, 0.0);
    CustomItem cowmeat =
        new CustomItem("Cow Meat", 3, true, false, "Prime beef", Material.BEEF, 9.0, 0.0);
    CustomItem rabbitmeat =
        new CustomItem("Rabbit Meat", 3, true, false, "Not too gamey", Material.RABBIT, 6.0, 0.0);
    CustomItem foxmeat =
        new CustomItem(
            "Fox Meat", 4, true, false, "Better than chicken!", Material.CHICKEN, 4.0, 0.0);
    CustomItem boarhide =
        new CustomItem(
            "Boar Hide", 4, true, false, "Extermely tough hide", Material.RABBIT_HIDE, 10.0, 0.0);
    CustomItem cowhide =
        new CustomItem("Cow Hide", 4, true, false, "Good for boots", Material.LEATHER, 13.0, 0.0);
    CustomItem rabbithide =
        new CustomItem(
            "Rabbit Hide",
            4,
            true,
            false,
            "Good for small leather work",
            Material.LIGHT_GRAY_DYE,
            18.0,
            0.0);
    CustomItem foxfur =
        new CustomItem(
            "Fox Fur", 4, true, false, "Warmest fur on the market", Material.ORANGE_DYE, 16.0, 0.0);
    CustomItem geode =
        new CustomItem(
            "Geode",
            4,
            true,
            false,
            "Bring to geologist to open",
            Material.FIREWORK_STAR,
            0.0,
            0.0);
    CustomItem minerspick =
        new CustomItem(
            "Old Miner's Pick",
            4,
            true,
    ...
    CustomItem procsmokeleaf =
        new CustomItem(
            ...
            19.0,
            0.0);
    CustomItem spicebottle =
        new CustomItem(
            "Spice", 4, false, false, "Smell's like the future", Material.HONEY_BOTTLE, 68.0, 0.0);
    CustomItem oil =
        new CustomItem(
            "Unrefined Oil",
            4,
            false,
            false,
            "Refine for higher sale value",
            Material.BUCKET,
            0.0,
            0.0);
    CustomItem frenzyrecipe =
        new CustomItem(
            "Miner's Frenzy Brew Recipe",
            3,
            true,
            false,
            ...
            0.0,
            1);
    CustomItem doublespaderecipe =
        new CustomItem(
            "Miner's Double Spade Brew Recipe",
            3,
            true,
            false,
            "Right click to view recipe",
            ...
            0.0,
            1);
    CustomItem greenthumbrecipe =
        new CustomItem(
            "Green Thumb Brew Recipe",
            3,
            true,
            false,
            "Right click to view recipe",
            ...
            0.0,
            1);
    CustomItem fermentliquorrecipe =
        new CustomItem(
            "Fermented Liquor Recipe",
            3,
            true,
            false,
            "Right click to view recipe",
    ...
    new CustomItem(
        ...
        true,
        false,
        "Brews into a slow heal",
        Material.PUMPKIN_SEEDS,
        0.0,
        0.0,
        1);
    CustomItem frenziedStems =
        new CustomItem(
            "Frenzied Stems",
            5,
            true,
            false,
            "Used on workers for productivity",
            Material.FIRE_CORAL,
            0.0,
            0.0,
            1);
    CustomItem heartFruit =
        new CustomItem(
            "Heart Fruit", 5, true, false, "Still beating", Material.SWEET_BERRIES, 0.0, 0.0, 1);

    CustomItem amethystBud =
        new CustomItem(
            "Amethyst Bud",
            6,
            true,
            ...
            0.0,
            1);
    CustomItem mossyJade =
        new CustomItem(
            "Mossy Jade",
            5,
            true,
            false,
            "Look's alive under light",
            Material.SLIME_BALL,
            65.0,
            0.0,
            1);

    CustomItem hermitCrab =
        new CustomItem(
            "Hermit Crab", 5, true, false, "Fish love it", Material.NAUTILUS_SHELL, 8.0, 15.0, 3);
    CustomItem refinedOil =
        new CustomItem(
            "Refined Oil",
            6,
            false,
            ...
            0.0,
            1);
    CustomItem southernsalmon =
        new CustomItem(
            "Southern Salmon",
            6,
            true,
            false,
            "Migrated south through southern tributaries",
            Material.MUSIC_DISC_FAR,
            175.0,
            0.0,
            1);
    CustomItem arcticsalmon =
        new CustomItem(
            "Arctic Salmon",
            6,
            true,
    ...
    CustomItem oilfieldkey =
        new CustomItem(
            "Crate Key",
            6,
            false,
            false,
            "Unlocks crates at oil field",
            Material.TRIPWIRE_HOOK,
            0.0,
            0.0,
            1);
    CustomItem steelLinedRod =
        new CustomItem(
            "Steel Lined Rod",
            6,
            true,
            ...
            Enchantment.LURE,
            1);
    CustomItem explorerspick =
        new CustomItem(
            "Explorer's Pick",
            6,
            true,
            false,
            "Aids in climbing glaciers",
    ...
    // LEGENDARY
    CustomItem alligator =
        new CustomItem(
            "Alligator", 8, true, false, "Crikey!", Material.MUSIC_DISC_CHIRP, 425.0, 0.0, 1);
    CustomItem sunkenCatfish =
        new CustomItem(
            "Sunken Catfish",
            8,
            true,
            false,
            "Evolved in the low-lands",
            Material.MUSIC_DISC_BLOCKS,
            400.0,
            0.0,
            1);
    CustomItem goldstonnedherring =
        new CustomItem(
            "Gold Stoned Herring",
            7,
            true,
            false,
            "The rare mutation of the gray herring",
            Material.MUSIC_DISC_MELLOHI,
            250.0,
            0.0,
            1);
    CustomItem pearlrivertrout =
        new CustomItem(
            "Pearl River Trout",
            7,
            true,
            false,
            "Alluring rainbow scales",
            Material.MUSIC_DISC_CAT,
            275.0,
            0.0,
            1);
    CustomItem expaditionRod =
        new CustomItem(
            "Expedition Rod",
            8,
            true,
    ...
    new CustomItem(
        "Pirates booty", 8, true, false, "Richest dabloon", Material.SUNFLOWER, 0.0, 0.0, 1);
    new CustomItem(
        "Oil Barrel",
        7,
        false,
        false,
        "A large amount of refined oil",
    ...
    new CustomItem(
        ...
        true,
        false,
        "It smell makes dreams come true",
    ...
    new CustomItem(
        ...
        true,
        false,
        "Crystals explode out of the sides",
        Material.MUSIC_DISC_11,
        0.0,
        0.0,
        1);
    new CustomItem(
        "River Diamond", 7, true, false, "The root of many wars", Material.DIAMOND, 555.0, 0.0, 1);
    new CustomItem(
        "Baron's Emerald",
        7,
        true,
        false,
        "An old king was fond of these",
        Material.EMERALD,
        575.0,
        0.0,
        1);
    new CustomItem(
        ...
        true,
        false,
        "Stare into the depths of the universe",
        Material.ECHO_SHARD,
        635.0,
        0.0,
        1);
    ...
    // ARMOR
    new CustomItem(
        "Farm Hand Boots", 1, true, false, "'Size too big", Material.LEATHER_BOOTS, 0.0, 350.0, 1);
    new CustomItem(
        "Farm Hand Chaps",
        2,
        true,
    ...
    new CustomItem(
        "Huntsmen Boots", 3, true, false, "Rusty Spurs", Material.IRON_BOOTS, 0.0, 924.0, 1);
    new CustomItem(
        "Huntsmen Trousers", 4, true, false, "Mostly fur", Material.IRON_LEGGINGS, 0.0, 1188.0, 1);
    new CustomItem(
        "Huntsmen Jacket",
        4,
        true,
        ...
        1);
    new CustomItem(
        "Huntsmen Hat", 3, true, false, "Fox fur cap", Material.IRON_HELMET, 0.0, 858.0, 1);
    ...
    new CustomItem(
        "Sheriff Jacket", 4, true, true, "", Material.CHAINMAIL_CHESTPLATE, 0.0, 1320.0, 1);
    ...
    new CustomItem(
        "Marshall Boots", 3, true, true, "Freshly shined", Material.DIAMOND_BOOTS, 0.0, 5950.0, 1);
    ...
    new CustomItem(
        "Flame Bow", 8, false, false, "", Material.BOW, 0.0, 0.0, 1, Enchantment.ARROW_FIRE, 2);
    new CustomItem(
        "Hard Bow", 8, false, false, "", Material.BOW, 0.0, 0.0, 1, Enchantment.ARROW_DAMAGE, 6);
  ...
  public static void loadItemTables() {
    ...
    // Crates
    // Journeyman's hat/duster, frontier set, sawed off, colt navy, 66 winchester, henry model 3,
    // explorer's pick
    // green thumb brew
  ...
  public static void loadLocations(IronSight plugin) {
    ...
    FrontierLocation northoil =
        new FrontierLocation(
            "North Moraine Oil Field",
            "Illegal area!",
            LocationType.ILLEGAL,
            2827,
            3041,
            -2951,
            -3189);
    FrontierLocation southoil =
        new FrontierLocation(
            "South Oil Field", "Illegal area!", LocationType.ILLEGAL, 778, 602, 1480, 1720);
    ...
    new FrontierLocation(
        "Prison", "JaiL!", LocationType.PRISON, 2079, 1794, -799, -959, 1987, 94, -920);
    new FrontierLocation("Wilderness", "Yeehaw", LocationType.WILDERNESS, 0, 0, 0, 0);
    new FrontierLocation(
        "Sierra Gorge Camp", "Scavenger Town", LocationType.EVENT, 2834, 2543, 819, 466);
    // MINES
    new FrontierLocation(
        "Black Spur Mines", "Be weary of the depths", LocationType.MINE, 1542, 2248, -2102, -1775);
    // RIVERSS
    new FrontierLocation(
        "Slough Creek River", "Fishings good", LocationType.RIVER, 2542, 2766, 445, 69);
    new FrontierLocation(
        "Pearl River", "Ice cold rapids!", LocationType.RIVER, 2599, 2083, -2596, -2475);
    new FrontierLocation(
        "Three Forks Delta",
        "A thick and nasty swamp",
        LocationType.RIVER,
        -1402,
        -1161,
        -2967,
    ...
    // FIELDS
    new FrontierLocation(
        "Smokeleaf Field", "Grown in damp ground", LocationType.ILLEGAL, 1014, 947, -2857, -2778);
    new FrontierLocation(
        "Spice Field",
        "Harvested spice burns the earth",
        LocationType.ILLEGAL,
        -1550,
        -1447,
        636,
  ...
  public static void loadIcons() {
    ...
    //      ===--- RESPAWN UI ICONS ---===
    ItemIcon santafeRespawn =
        new ItemIcon(
            "Santa Fe", "santa_fe_respawn", "Click to respawn here", Material.WHITE_BANNER);
    ItemIcon neworleansRespawn =
        new ItemIcon(
            "New Orleans", "new_orleans_respawn", "Click to respawn here", Material.BLUE_BANNER);
    ItemIcon texasRespawn =
        new ItemIcon(
            "Republic Of Texas",
            "republic_of_texas_respawn",
            "Click to respawn here",
            Material.YELLOW_BANNER);

    //      ===--- CONTRACT UI ICONS ---===
    ItemIcon contractLoc =
        new ItemIcon(
            ChatColor.BOLD + "Locations:",
            "contract_location",
            "Go here to complete.",
            Material.COMPASS);
    ItemIcon contractReq =
        new ItemIcon(
            ChatColor.BOLD + "Request:", "contract_req", "Requested items:", Material.DIAMOND);
    ItemIcon contractDesc =
        new ItemIcon(
            ChatColor.BOLD + "Description",
            "contract_desc",
            "What to do:",
    ...
    ItemIcon tracker =
        new ItemIcon(
            "Tracker", "tracker_prefix", "Choose tracker (Level 5)", Material.LEATHER_BOOTS);
    ItemIcon medic =
    ...
    ItemIcon explorer =
        new ItemIcon(
            "Explorer", "explorer_prefix", "Choose explorer (Level 10)", Material.SPYGLASS);
    ItemIcon contractorTitle =
        new ItemIcon(
            "Contractor Title",
            "contractor_title",
            "Select your prefix",
    ...
    new ItemIcon(ChatColor.GREEN + "Rookie Difficulty", "rookie_slot", "", Material.PLAYER_HEAD);
    new ItemIcon(
        ChatColor.YELLOW + "Apprentice Difficulty", "apprentice_slot", "", Material.SKELETON_SKULL);
    new ItemIcon(
        ChatColor.RED + "Experienced Difficulty",
        "experienced_slot",
        "",
    ...
    //      ===--- TRACKER UI ICONS ---===
    new ItemIcon(
        "Spice Field", "spice_field_tracker", "Directions to Spice Field", Material.HONEY_BOTTLE);
    ...
    new ItemIcon(
        "New Orleans", "new_orleans_tracker", "Directions to New Orleans", Material.YELLOW_BANNER);
    new ItemIcon(
        "Republic of Texas",
        "republic_of_texas_tracker",
        "Directions to the Republic of Texas",
        Material.BLUE_BANNER);
    new ItemIcon("Players", "player_tracker", "Find players", Material.PLAYER_HEAD);
    new ItemIcon(
        "Nearest Wanted Player", "wanted_tracker", "Nearest wanted player", Material.ZOMBIE_HEAD);
    ...
    new ItemIcon(
        "Illegal Arms Dealer", "illegal_arms_tracker", "Illegal Arms Dealer", Material.IRON_AXE);
    ItemIcon armorer =
        new ItemIcon("Armorer", "armorer_tracker", "Find Armorer", Material.LEATHER_CHESTPLATE);
    ItemIcon illegalArmor =
        new ItemIcon(
            "Illegal Armorer",
            "illegal_armorer_tracker",
            "Find Illegal Armorer",
            Material.NETHERITE_CHESTPLATE);
    ItemIcon generalStore =
    ...
    ItemIcon stableManager =
        new ItemIcon(
            "Stable Manager", "stable_manager_tracker", "Find Stable Manager", Material.SADDLE);
    ...
    ItemIcon ferryCaptain =
        new ItemIcon(
            "Ferry Captain", "ferry_captain_tracker", "Find Ferry Captain", Material.BIRCH_BOAT);
    ItemIcon bankTeller =
        new ItemIcon("Bank Teller", "bank_teller_tracker", "Find Bank Teller", Material.GOLD_INGOT);
    ItemIcon itemVault =
        new ItemIcon(
            "Vault Keeper", "vault_keeper_tracker", "Find Vault Keeper", Material.ENDER_CHEST);
    ItemIcon contractor =
        new ItemIcon("Contractor", "contractor_tracker", "Find Contractor", Material.BOOK);
    ItemIcon chief =
        new ItemIcon(
            "Chief of Police", "chief_of_police_tracker", "Find the Chief", Material.PIGLIN_HEAD);
    ...
    new ItemIcon(
        "Black Spur Mines",
        "black_spur_mines_tracker",
        "Find the Black Spur Mines",
        Material.IRON_ORE);
    new ItemIcon(
        "Barron's Canyon", "barrons_canyon_tracker", "Find Barron's Canyon", Material.TERRACOTTA);
    new ItemIcon(
        "Half Dome Mines", "half_dome_tracker", "Find the Half Dome Mines", Material.STONE);
    ...
    new ItemIcon(
        "Three Forks Delta",
        "three_forks_delta_tracker",
        "Find Three Forks Delta",
        Material.MUSIC_DISC_CHIRP);
    new ItemIcon(
        "Lower Guadalupe River",
        "lower_guadalupe_tracker",
        "Find Guadalupe River",
        Material.MUSIC_DISC_BLOCKS);
    new ItemIcon(
        "Slough Creek River",
        "slough_creek_river_tracker",
        "Find Slough Creek",
        Material.MUSIC_DISC_FAR);

    new ItemIcon(
        "Forest Reserves", "forest_reserves_tracker", "Find Forest Reserves", Material.OAK_SAPLING);
    new ItemIcon(
        "Grizzly Ridge", "grizzly_ridge_tracker", "Find Grizzly Ridge", Material.OAK_SAPLING);
    new ItemIcon(
        "Marston Glacier",
        "marston_glacier_tracker",
        "Find Marston Glacier",
        Material.BIRCH_SAPLING);
    new ItemIcon(
        "Hawk Ridge Forest",
        "hawk_ridge_forest_tracker",
        "Find Hawk Ridge Forest",
        Material.ACACIA_SAPLING);

    new ItemIcon("Sentinel Rock", "sentinel_rock_tracker", "Find Sentinel Rock", Material.QUARTZ);
    new ItemIcon(
        "Bandit Camps", "bandit_camp_tracker", "Find Bandit Camps", Material.SKELETON_SKULL);
    new ItemIcon("Red Ash Camp", "red_ash_camp_tracker", "Find Red Ash Camp", Material.REDSTONE);
    new ItemIcon(
        "Storm Point Rebel Base",
        "storm_point_tracker",
        "Find Storm Point",
        Material.WITHER_SKELETON_SKULL);
    new ItemIcon("Scav Towns", "scav_town_tracker", "Find Scav Towns", Material.OAK_DOOR);
    new ItemIcon(
        "Florence Peak", "florence_peak_tracker", "Find Florence Peak", Material.ACACIA_DOOR);
    new ItemIcon(
        "Washington Column",
        "washington_column_tracker",
        "Find Washington Column",
    ...
    new ItemIcon(
        "North Moraine Oil Field",
        "north_moraine_oil_field_tracker",
        "Find North Moraine Oil Field",
        Material.BUCKET);
    new ItemIcon("Drug Fields", "drug_field_tracker", "Find Drug Fields", Material.KELP);
    new ItemIcon(
        "Smokeleaf Drug Field",
        "smokeleaf_field_tracker",
        "Find Smokeleaf Drug Field",
        Material.ENDER_PEARL);

    new ItemIcon(
        "Complete Contract",
        "complete_contract",
        "Click if all steps are complete",
    ...
    new ItemIcon(
        "Upgrade Vault",
        "upgrade_vault_confirm",
        "50,000g for 6 more slots",
        Material.EMERALD_BLOCK);
    ...
    new ItemIcon(
        "Open Account",
        "open_account",
        "Open an item vault account for 25,000g",
        Material.EMERALD_BLOCK);
  ...
  public static void loadNPCs() {
    ...
    new NPC(
        ...
        true,
        false,
        FrontierLocation.getLocation("Santa Fe"));
    new NPC(
        "Contractor",
        NPCType.CONTRACTOR,
        1055,
    ...
    new NPC(
        ...
        true,
        false,
        FrontierLocation.getLocation("New Orleans"));
    new NPC(
        "Contractor",
        NPCType.CONTRACTOR,
        -1372,
    ...
    new NPC(
        ...
        true,
        false,
        FrontierLocation.getLocation("Republic of Texas"));
    new NPC(
        "Contractor",
        NPCType.CONTRACTOR,
        -1030,
    ...
    new NPC(
        ...
        false,
        false,
        FrontierLocation.getLocation("Storm Point"));
    new NPC(
        "Illegal Arms Dealer",
        NPCType.ILL_ARMS_DEALER,
        -17,
        105,
        -2907,
        ChatColor.DARK_AQUA,
    ...
    new NPC(
        ...
        false,
        false,
        FrontierLocation.getLocation("Red Ash Camp"));
    new NPC(
        "Illegal Arms Dealer",
        NPCType.ILL_ARMS_DEALER,
        -1316,
  ...
  public static void loadProcessors() {
    ...
    new Processor(
        ...
        ProcessorType.SMOKE_LEAF,
        FrontierLocation.getLocation("Storm Point"),
        CustomItem.getCustomItem("Unprocessed Smokeleaf").getItemStack(),
        CustomItem.getCustomItem("Processed Smokeleaf").getItemStack());
    new Processor(
    ...
    new Processor(
        ...
        ProcessorType.SPICE,
        FrontierLocation.getLocation("Red Ash Camp"),
        CustomItem.getCustomItem("Unprocessed Spice").getItemStack(),
        CustomItem.getCustomItem("Spice").getItemStack());
    new Processor(
        "Spice processor 2",
        ProcessorType.SPICE,
        FrontierLocation.getLocation("Red Ash Camp"),
  ...
  public static void loadPotions() {
    ...
    new CustomPotion(
        ...
        0);
    new CustomPotion(
        "Medicine", "Grows new limbs", 0.0, 100, 3, 253, 94, 94, 10, PotionEffectType.HEAL, 1);
  }
}
