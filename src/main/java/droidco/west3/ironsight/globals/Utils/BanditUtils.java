...
public class BanditUtils {
    ...
    public static String getContractorTitle(Bandit b) {
        return switch (b.getContractorTitle()) {
            case 0 -> "";
            case 1 -> String.valueOf(ChatColor.GRAY) + "Miner";
            case 2 -> String.valueOf(ChatColor.GRAY) + "Cowboy";
            case 3 -> String.valueOf(ChatColor.DARK_GREEN) + "Tracker";
            case 4 -> String.valueOf(ChatColor.GREEN) + "Medic";
            case 5 -> String.valueOf(ChatColor.DARK_RED) + "Raider";
            case 6 -> String.valueOf(ChatColor.YELLOW) + "Explorer";
            default -> "";
        };
    }
