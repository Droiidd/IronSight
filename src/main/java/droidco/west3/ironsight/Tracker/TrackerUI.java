...
public class TrackerUI {
    ...
    public static Inventory openTrackerUI(Player p) {
        Inventory trackerUi = Bukkit.createInventory(p, 27, ChatColor.DARK_RED + "Tracker");
    ...
    public static Inventory openTownsUi(Player p) {
        Inventory townsUi = Bukkit.createInventory(p, 27, ChatColor.DARK_GRAY+ "Towns");
    ...
    public static Inventory openMerchantsUi(Player p) {
        Inventory merchantsUi = Bukkit.createInventory(p, 27, ChatColor.GOLD + "Merchants");
        Bandit iPlayer = Bandit.getPlayer(p);
    ...
    public static Inventory openMinesUi(Player p) {
        Inventory minesUi = Bukkit.createInventory(p, 27, ChatColor.GOLD + "Mines");
    ...
    public static Inventory openRiversUi(Player p) {
        Inventory riversUi = Bukkit.createInventory(p, 27, ChatColor.BLUE + "Rivers");
    ...
    public static Inventory openBanditCampsUi(Player p) {
        Inventory banditCampsUi = Bukkit.createInventory(p, 27, ChatColor.RED+ "Bandit Camps");
