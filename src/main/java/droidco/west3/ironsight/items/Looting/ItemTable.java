...
public class ItemTable {
    ...
    private static final int legendary = 100 - common - uncommon - rare;

    //rarity relative in a rarity class
    //i.e all ones = 60%, meaning twos are 40%
    private static final int com_split = 50;
    private static final int unc_split = 50;
    private static final int rare_split = 50;
    private static final int leg_split = 50;
    private static final HashMap<String, ItemTable> tables = new HashMap<String, ItemTable>() {
    };
    private final HashMap<String, Quantity> quantities;
    ...
    public ItemTable(HashMap<String, Quantity> items_map, String name) {
        ...
        for (String string : items) {
            CustomItem item = CustomItem.getCustomItem(string);
            if (item == null) {
                System.out.println("\nItemTables init" + string + " is not in CustomItems.items\n");
            } else {
